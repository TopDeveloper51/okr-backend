...
public class IntercomController {
	...
	public ResponseEntity<?> selectByFields(@RequestBody Intercom param) {
		try {
			List<Intercom> ret = mService.selectByFields(param);
	...
	public ResponseEntity<?> addOne(@RequestBody Intercom param) {
		try {
			...
			if (ret == 0) {
				...
				Intercom newObj = new Intercom();
				newObj.ic_id = param.ic_id;
				List<Intercom> retObj = mService.selectByFields(newObj);
	...
	public ResponseEntity<?> deleteByFields(@RequestBody Intercom param) {
		try {
	...
	public ResponseEntity<?> updateByFields(@RequestBody Intercom param) {
		try {
