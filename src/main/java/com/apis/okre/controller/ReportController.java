...
public class ReportController {
	...
	public ResponseEntity<?> selectByFields(@RequestBody Report param) {
		try {
			List<Report> ret = mService.selectByFields(param);
	...
	public ResponseEntity<?> addOne(@RequestBody Report param) {
		try {
			...
			if (ret == 0) {
				...
				Report newObj = new Report();
				newObj.rp_id = param.rp_id;
				List<Report> retObj = mService.selectByFields(newObj);
	...
	public ResponseEntity<?> deleteByFields(@RequestBody Report param) {
		try {
	...
	public ResponseEntity<?> updateByFields(@RequestBody Report param) {
		try {
