...
public class UserController {
	...
	public ResponseEntity<?> selectByFields(@RequestBody User param) {
		try {
			List<User> ret = mService.selectByFields(param);
	...
	public ResponseEntity<?> deleteByFields(@RequestBody User param) {
		try {
	...
	public ResponseEntity<?> updateByFields(@RequestBody User param) {
		try {
