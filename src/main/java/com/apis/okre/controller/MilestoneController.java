...
public class MilestoneController {
	...
	public ResponseEntity<?> selectByFields(@RequestBody Milestone param) {
		try {
			List<Milestone> ret = mService.selectByFields(param);
	...
	public ResponseEntity<?> addOne(@RequestBody Milestone param) {
		try {
			...
			if (ret == 0) {
				...
				Milestone newObj = new Milestone();
				newObj.ms_id = param.ms_id;
				List<Milestone> retObj = mService.selectByFields(newObj);
	...
	public ResponseEntity<?> deleteByFields(@RequestBody Milestone param) {
		try {
	...
	public ResponseEntity<?> updateByFields(@RequestBody Milestone param) {
		try {
